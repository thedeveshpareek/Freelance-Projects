        ...
        <>
            <div className='bg-white sm:bg-secondary main__bottomPadding'>
                ...
                <div className='main__padding'>
                    <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 my-4 md:py-4 lg:py-8'>Terms & Conditions</h1>
