                        ...
                        <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7]">
                            ...
                            <div className='w-full'>
                                <div>
                                    ...
                                    <h6 className='items-center text-[#555555] gap-2 italic hidden md:flex'>Order <ChevronRightIcon className='h-3 w-3 mt-1 ' /> History</h6>
                                    <div className='md:flex justify-between items-center  w-[100%]'>
                                        <div className='hidden md:block'>
                                            <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-gray-800 pt-5 md:pt-4 lg:pt-6 hidden md:block'>Order History</h1>
                                            <p className='text-[#525252] my-3 font-satoshi font-normal text-sm'>Keep track of all your appointment Payment History here</p>
                                        </div>


                                        <div className='px-7 md:px-4 lg:px-0'>
                                            <button className='hidden md:flex border-2 border-primary rounded-2xl py-3 px-4 w-[25vh] items-center justify-center gap-5'>
                                            ...
                                            <div className='bg-gray-200 rounded-lg flex md:hidden justify-between'>
