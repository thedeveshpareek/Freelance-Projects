            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-hidden  min-h-[85vh] ">
                <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7] bg-[#fff5f8]">
                    <div className='w-full'>
                        <h1 className='block md:hidden text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 pb-4 lg:pb-8'> Account </h1>

                        <div className='flex md:justify-between justify-end items-center pt-5 md:pt-4 lg:pt-6'>
                            <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-gray-800  hidden md:block'>Account</h1>
                            <div className='flex gap-7 text-primary font-medium items-center font-raleway'>
                                <p className='hidden md:block'>
                                    <Link passHref href='/admin/familyMember' legacyBehavior>
                                        <a>
                                            Family Member
                                        </a>
                                    </Link>
                        ...
                        <div className='mt-3'>
                            <form action="#">
                                <div className="sm:overflow-hidden sm:rounded-md">
                                    <div className="space-y-6 bg-transparent px-4 py-2">
                                        <div>
                                                ...
                                                <div className='hidden md:block'>
                                                    <div className='bg-[#D9D9D9] p-3 rounded-full'>
                                                        <svg width="59" height="59" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="30" cy="13" r="12" stroke="#919191" stroke-width="2" />
                                                            <path d="M40.5003 20C50.667 23.3333 57.8014 37.5 57.0014 57.5" stroke="#919191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M18.5 19C8.33333 22.3333 1.25768 36.5 2.05768 56.5" stroke="#919191" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    </div>
                                                    <p className='font-satoshi text-xs md:text-sm lg:text-base mt-2 md:mt-3 text-black'>Edit Profile</p>
                                                </div>

                                                <div className='pt-1 md:pt-3 grid grid-cols-1 sm:grid-cols-2 gap-5'>
                                                    <div className='w-full'>
                                                        <label htmlFor="first-name" className="block text-sm md:text-base text-[#1B1B1B] font-normal font-inter mb-1">
                                                            Name
                                                        </label>
                                                        <FormInput inputText='Enter Your name' />
                                                    </div>

                                                    <div className='w-full'>
                                                        <label className="block text-sm md:text-base text-[#1B1B1B] font-normal font-inter mb-1">
                                                            Phone Number
                                                        </label>
                                                        <FormInput inputText='Enter Your Number' />
                                                    </div>
                                                </div>
                                            </div>

                                            <div className='w-full h-[1px] my-6 md:my-7 bg-[#fbc9d7]'></div>
                                            ...
                                            <div className='grid sm:grid-cols-3 gap-5 mt-5'>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Enter Your Email' />
                                                </div>
                                            ...
                                            <div className='grid sm:grid-cols-3 gap-5 mt-5'>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Languages Known' />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Type Bloodgroup' />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Enter Your timezone' />
                                                </div>
                                            </div>
                                            ...
                                            {/* Bottom Section */}
                                            <p className='font-medium text-[#272727] font-raleway'>
                                                Address
                                            </p>
                                            ...
                                            <div className='grid grid-cols-1 sm:grid-cols-3 gap-5 mt-5 '>
                                                <div>
                                                    ...
                                                    <FormInput inputText='Enter Your City' />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Enter Your state' />
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <FormInput inputText='Enter Your Country' />
                                                </div>
                                            </div>
