...
import RecordTable from '../../components/Admin/Tables/RecordTable'
                ...
                <div className="flex min-w-0 flex-1 flex-col overflow-hidden  min-h-[85vh] bg-[#fff5f8]">
                    <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7] ">
                        ...
                        <div className='w-full'>
                            <div>
                                <h1 className='block md:hidden text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 pb-4 lg:pb-8'> Medical record </h1>

                                <div className='md:flex justify-between items-center  w-[100%]'>
                                    <div className='hidden md:block'>
                                        <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-gray-800 pt-5 md:pt-4 lg:pt-6 hidden md:block'>Medical Records</h1>
                                        <p className='text-[#525252] my-3 font-satoshi font-normal text-sm'>Keep track of all your medical records</p>
                                    </div>

                                    <div className='flex gap-7 text-primary font-medium items-center font-raleway sm:justify-end'>
                                        <p className='hidden md:flex gap-3'>
                                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.625 2.5H13.875V1.625C13.875 1.39294 13.7828 1.17038 13.6187 1.00628C13.4546 0.842187 13.2321 0.75 13 0.75C12.7679 0.75 12.5454 0.842187 12.3813 1.00628C12.2172 1.17038 12.125 1.39294 12.125 1.625V2.5H6.875V1.625C6.875 1.39294 6.78281 1.17038 6.61872 1.00628C6.45462 0.842187 6.23206 0.75 6 0.75C5.76793 0.75 5.54538 0.842187 5.38128 1.00628C5.21719 1.17038 5.125 1.39294 5.125 1.625V2.5H3.375C2.67881 2.5 2.01113 2.77656 1.51884 3.26884C1.02656 3.76113 0.75 4.42881 0.75 5.125V15.625C0.75 16.3212 1.02656 16.9889 1.51884 17.4812C2.01113 17.9734 2.67881 18.25 3.375 18.25H15.625C16.3212 18.25 16.9889 17.9734 17.4812 17.4812C17.9734 16.9889 18.25 16.3212 18.25 15.625V5.125C18.25 4.42881 17.9734 3.76113 17.4812 3.26884C16.9889 2.77656 16.3212 2.5 15.625 2.5ZM16.5 15.625C16.5 15.8571 16.4078 16.0796 16.2437 16.2437C16.0796 16.4078 15.8571 16.5 15.625 16.5H3.375C3.14294 16.5 2.92038 16.4078 2.75628 16.2437C2.59219 16.0796 2.5 15.8571 2.5 15.625V9.5H16.5V15.625ZM16.5 7.75H2.5V5.125C2.5 4.89293 2.59219 4.67038 2.75628 4.50628C2.92038 4.34219 3.14294 4.25 3.375 4.25H5.125V5.125C5.125 5.35706 5.21719 5.57962 5.38128 5.74372C5.54538 5.90781 5.76793 6 6 6C6.23206 6 6.45462 5.90781 6.61872 5.74372C6.78281 5.57962 6.875 5.35706 6.875 5.125V4.25H12.125V5.125C12.125 5.35706 12.2172 5.57962 12.3813 5.74372C12.5454 5.90781 12.7679 6 13 6C13.2321 6 13.4546 5.90781 13.6187 5.74372C13.7828 5.57962 13.875 5.35706 13.875 5.125V4.25H15.625C15.8571 4.25 16.0796 4.34219 16.2437 4.50628C16.4078 4.67038 16.5 4.89293 16.5 5.125V7.75Z" fill="#EB1754" />
                                            </svg>

                                            <Link href='/admin/upcoming' passHref legacyBehavior>
                                                <a>Upcoming Appointment</a>
                                            </Link>
                                        </p>

                                        <button className='hidden sm:flex border-2 border-primary rounded-2xl py-3 px-4 w-[25vh] items-center justify-center gap-5'>

                                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M8 16C9.77498 15.9996 11.4988 15.4054 12.897 14.312L17.293 18.708L18.707 17.294L14.311 12.898C15.405 11.4997 15.9996 9.77544 16 8C16 3.589 12.411 0 8 0C3.589 0 0 3.589 0 8C0 12.411 3.589 16 8 16ZM8 2C11.309 2 14 4.691 14 8C14 11.309 11.309 14 8 14C4.691 14 2 11.309 2 8C2 4.691 4.691 2 8 2Z" fill="#EB1754" />
                                                <path d="M9.41378 6.58596C9.79278 6.96596 10.0018 7.46796 10.0018 7.99996H12.0018C12.0027 7.47439 11.8994 6.95386 11.6979 6.46845C11.4963 5.98304 11.2006 5.54239 10.8278 5.17196C9.31378 3.65996 6.68878 3.65996 5.17578 5.17196L6.58778 6.58796C7.34778 5.82996 8.65778 5.83196 9.41378 6.58596Z" fill="#EB1754" />
                                            </svg>
                                            <p className='text-primary font-bold'>Search</p>
                                        </button>
                                    </div>

                                    <div className='bg-gray-200 rounded-lg flex sm:hidden justify-between'>
                                        <Input inputText='Search Records' />
                                        <div className='bg-primary py-3 px-4 rounded-lg'>
                                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.33329 14C8.81244 13.9997 10.249 13.5045 11.4141 12.5933L15.0775 16.2566L16.2558 15.0783L12.5925 11.415C13.5041 10.2497 13.9996 8.81282 14 7.33329C14 3.65746 11.0091 0.666626 7.33329 0.666626C3.65746 0.666626 0.666626 3.65746 0.666626 7.33329C0.666626 11.0091 3.65746 14 7.33329 14ZM7.33329 2.33329C10.0908 2.33329 12.3333 4.57579 12.3333 7.33329C12.3333 10.0908 10.0908 12.3333 7.33329 12.3333C4.57579 12.3333 2.33329 10.0908 2.33329 7.33329C2.33329 4.57579 4.57579 2.33329 7.33329 2.33329Z" fill="white" />
                                                <path d="M8.50994 6.15495C8.82577 6.47162 8.99994 6.88995 8.99994 7.33328H10.6666C10.6673 6.89531 10.5813 6.46153 10.4133 6.05702C10.2454 5.65251 9.99897 5.2853 9.68827 4.97662C8.4266 3.71662 6.2391 3.71662 4.97827 4.97662L6.15494 6.15662C6.78827 5.52495 7.87994 5.52662 8.50994 6.15495Z" fill="white" />
                                            </svg>
