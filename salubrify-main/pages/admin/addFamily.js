            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-hidden  min-h-[85vh]">
                <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7] bg-[#fff5f8]">
                    ...
                    <div className='w-full'>
                        ...
                        <h1 className='block md:hidden text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 pb-4 lg:pb-8'> Add a Member </h1>

                        <div className='flex md:justify-between justify-end items-center pt-5 md:pt-4 lg:pt-6'>
                            <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-gray-800  hidden md:block'>Add Family Member</h1>
                        ...
                        <div className='w-full h-[1px]  my-6 md:mb-10 mt-7 bg-[#fbc9d7]'></div>
                                ...
                                <div className="sm:overflow-hidden sm:rounded-md">
                                    <div className="space-y-6 bg-transparent ">
                                        <div>
                                            ...
                                            {/* Top Section */}
                                            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 px-0 md:px-4 lg:px-7'>
                                                <div>
                                            ...
                                            <div className='w-full h-[1px] my-6 md:my-10 bg-[#fbc9d7]'></div>

                                            {/* Mid Section */}
                                            <div className='grid grid-cols-1 sm:grid-cols-3 gap-5 mt-5 px-0 md:px-4 lg:px-7'>
                                                <div>
                                            ...
                                            <div className='w-full h-[1px] my-6 bg-[#fbc9d7]'></div>


                                            {/* Bottom Section */}
                                            <p className='font-medium text-[#272727] font-raleway px-0 md:px-4 lg:px-7'>
                                                Address
                                            </p>
