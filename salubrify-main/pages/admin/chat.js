                ...
                <div className="flex min-w-0 flex-1 flex-col overflow-hidden  min-h-[85vh]">
                    <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7] bg-[#fff5f8]">
                        ...
                        <div className='w-full min-h-full'>
                            ...
                            <h1 className='block md:hidden text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 pb-4 lg:pb-8'> Chats </h1>

                            <div className='flex'>
                                <div className='w-full md:w-1/3 h-full md:border-r-[1px] border-[#EBBCCA]'>
                                    <div className='w-full mb-7 lg:mb-12'>
                                        <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-gray-800  hidden md:block'>Chats</h1>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-lg lg:text-xl font-semibold text-black">Dr Charu Singh</p>
                                                <p className="text-base font-raleway font-medium text-[#868686] group-hover:text-gray-700">Period & Pain</p>
                                            </div>
                                        </div>
                                        <div className='bg-[#EBBCCA] h-[1px] mx-7 my-3 '></div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-lg lg:text-xl font-semibold text-black">Dr Ria Nayyar</p>
                                                <p className="text-base font-raleway font-medium text-[#868686] group-hover:text-gray-700">Healthy Diet</p>
                                            </div>
                                        </div>
                                        <div className='bg-[#EBBCCA] h-[1px] mx-7 my-3 '></div>
                                        ...
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-3">
                                                <p className="text-lg lg:text-xl font-semibold text-black">Ms Sameer Manda</p>
                                                <p className="text-base font-raleway font-medium text-[#868686] group-hover:text-gray-700">Parenting Tips</p>
                                            </div>
                                        </div>
                                        <div className='bg-[#EBBCCA] h-[1px] mx-7 my-3 '></div>
                                ...
                                <div className='md:w-2/3 px-10 hidden md:block'>
                                    <div className='w-full mb-7 lg:mb-12 flex justify-between items-center'>
                                        <div className="flex items-center">
                                            <div>
                                                <img
                                        ...
                                        <div className='flex gap-5 items-center'>
                                            <div>
                                                <svg width="19" height="22" viewBox="0 0 19 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M18.5 17.75L17.4395 16.6895L15.5 18.629V12.5H14V18.629L12.0605 16.6895L11 17.75L14.75 21.5L18.5 17.75Z" fill="#EB1754" />
                                                    <path d="M9.5 19.9998H2V1.99977H8V6.49977C8.00119 6.89723 8.1596 7.27807 8.44065 7.55912C8.7217 7.84016 9.10254 7.99858 9.5 7.99977H14V10.2498H15.5V6.49977C15.5026 6.4012 15.4839 6.30323 15.4451 6.2126C15.4062 6.12197 15.3482 6.04083 15.275 5.97477L10.025 0.724767C9.95897 0.651525 9.87784 0.59348 9.7872 0.554635C9.69656 0.51579 9.59857 0.49707 9.5 0.499767H2C1.60254 0.500954 1.2217 0.65937 0.940651 0.940418C0.659604 1.22147 0.501187 1.60231 0.5 1.99977V19.9998C0.501187 20.3972 0.659604 20.7781 0.940651 21.0591C1.2217 21.3402 1.60254 21.4986 2 21.4998H9.5V19.9998ZM9.5 2.29977L13.7 6.49977H9.5V2.29977Z" fill="#EB1754" />
                                                </svg>
                                            ...
                                            <div>
                                                <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M4.38394 0.479124C4.90904 0.320805 5.47252 0.347107 5.98059 0.553653C6.48865 0.760198 6.91065 1.13453 7.17634 1.61432L7.26514 1.79312L8.05954 3.55832C8.30063 4.0941 8.37889 4.68894 8.28458 5.26885C8.19028 5.84875 7.92757 6.38814 7.52914 6.81992L7.36954 6.97832L6.11794 8.14592C5.89234 8.35952 6.06154 9.18632 6.87754 10.5999C7.61194 11.8719 8.20954 12.4659 8.50354 12.4983H8.55514L8.61874 12.4863L11.0787 11.7339C11.4094 11.6325 11.7622 11.6285 12.095 11.7224C12.4278 11.8162 12.7266 12.004 12.9555 12.2631L13.0647 12.4011L14.6931 14.6571C15.0123 15.0993 15.1713 15.637 15.144 16.1817C15.1168 16.7263 14.9048 17.2454 14.5431 17.6535L14.3967 17.8047L13.7463 18.4215C13.1623 18.9746 12.4317 19.3484 11.6414 19.4984C10.8511 19.6483 10.0344 19.5682 9.28834 19.2675C6.96634 18.3315 4.85674 16.1931 2.94034 12.8739C1.02034 9.54632 0.222337 6.64592 0.578737 4.16192C0.686586 3.41104 0.995786 2.70339 1.4735 2.11412C1.95121 1.52485 2.5796 1.07596 3.29194 0.815124L3.52354 0.738324L4.38394 0.479124Z" fill="#EB1754" />
                                                </svg>
                                            </div>

                                            <div>
                                                <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M16 2C16 0.897 15.103 0 14 0H2C0.897 0 0 0.897 0 2V12C0 13.103 0.897 14 2 14H14C15.103 14 16 13.103 16 12V8.667L20 12V2L16 5.333V2Z" fill="#EB1754" />
                                                </svg>
                                    ...
                                    <div>
                                        <div className='flex justify-start'>
                                            <span className='text-[#3F3F3F] w-56 bg-[#D9D9D9] p-4 rounded-md'>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            </span>
                                        </div>

                                        <div className='flex justify-end mt-2'>
                                            <span className='text-[#3F3F3F] w-56 bg-[#ebbcca] p-4 rounded-md'>
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            </span>
                                        </div>
                                    ...
                                    <div className='bg-[#F2EEEE] mt-10 rounded-xl flex'>
                                        <input className='bg-transparent h-full p-3 w-full focus:outline-none' placeholder='Your Message' />
                                        <div className='flex gap-3 p-3'>
                                            <MicrophoneIcon className='h-5 w-5 text-[#999999]' />
                                            <PaperClipIcon className='h-5 w-5 text-[#999999]' />
                                            <div className='w-[1px] bg-[#999999]'></div>
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M23.711 1.29001C23.576 1.15569 23.4055 1.06268 23.2195 1.02194C23.0335 0.981196 22.8397 0.994405 22.661 1.06001L0.660977 9.06001C0.471245 9.13198 0.307897 9.25996 0.192628 9.42697C0.0773595 9.59397 0.015625 9.79209 0.015625 9.99501C0.015625 10.1979 0.0773595 10.3961 0.192628 10.5631C0.307897 10.7301 0.471245 10.858 0.660977 10.93L9.25098 14.36L15.591 8.00001L17.001 9.41001L10.631 15.78L14.071 24.37C14.1451 24.5561 14.2733 24.7156 14.4392 24.8279C14.605 24.9403 14.8007 25.0002 15.001 25C15.2031 24.9959 15.3991 24.9306 15.5634 24.8128C15.7276 24.6949 15.8523 24.5301 15.921 24.34L23.921 2.34001C23.9891 2.16309 24.0055 1.97044 23.9684 1.78454C23.9312 1.59863 23.8419 1.42712 23.711 1.29001Z" fill="#EB1754" />
                                            </svg>
