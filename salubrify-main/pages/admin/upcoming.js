...
const upcoming = () => {
    ...
    return (
        ...
        <div className="flex h-full">
            ...
            {/* Right Section */}
            <div className="flex min-w-0 flex-1 flex-col overflow-hidden min-h-[85vh] bg-[#fff5f8]">
                <div className="bg-primaryLight  py-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7]">
                    ...
                    <div className='w-full relative'>
                        ...
                        <div className='items-center justify-end md:justify-between flex'>
                            <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center text-gray-800 py-5 md:py-4 lg:py-8 hidden md:block'>Upcoming Bookings </h1>
                        ...
                        <div className='bg-white rounded-3xl mt-4 md:mt-2 lg:mt-0 bx'>
                            {/* Top Section */}
                            ...
                            {/* Bottom Section */}
                            <div className='bg-transparent px-6 pb-6 grid sm:grid-cols-3 gap-5'>
                                <div>
                                    <p className='font-medium font-raleway text-sm md:text-base lg:text-lg text-black md:text-[#676767]'>
                                        Date & Time
                                    </p>
                                    <p className='mt-2 text-xs md:text-sm font-raleway font-medium  text-black'>
                                        25-April-2022 <br />
                                        5:00pm
                                    </p>
                                </div>
                                ...
                                <div className='lg:text-end'>
                                    ...
                                    <p className='mt-2 text-xs md:text-sm font-raleway font-medium  text-[#0068AC]'>
                                        meet.google.com/34ghfr456
                                    </p>
                                </div>

                            </div>
                        </div>
                        <div className='bg-transparent flex justify-between mt-16 pt-16'>
