import { CheckBadgeIcon, ComputerDesktopIcon, HandThumbUpIcon, ReceiptPercentIcon } from '@heroicons/react/24/outline'
        ...
        <div className='bg-secondary_light'>
            ...
            <div className="flex h-full">
                ...
                <div className="flex min-w-0 flex-1 flex-col overflow-hidden  min-h-[85vh] bg-[#fff5f8]">
                    <div className="bg-primaryLight pb-6 pt-5 relative z-0 flex flex-1 overflow-hidden h-full lg:border-t-[1px] px-4 md:px-10 lg:border-[#fbc9d7]">
                        {/* Component */}
                        <div className='w-full'>
                            <div>
                                <h1 className='text-xl md:text-2xl lg:text-[32px] font-playfair tracking-wide font-bold text-center sm:text-start text-gray-800 pt-5 md:pt-4 lg:pt-8 my-3'>Redeem Voucher</h1>
                                <p className='text-[#667085] mb-4 font-satoshi text-center sm:text-start text-[11px] sm:text-xs lg:text-sm max-w-xs sm:max-w-fit mx-auto sm:mx-0'>Voucher Unlocks Special Benefits on Salubrify Website, These are available only through Select corporate PartnerS or events</p>
                            </div>

                            <div className='bx flex md:bg-white bg-transparent rounded-xl h-10 sm:h-auto'>
                                <div className='bg-[#E5DCDF] sm:bg-white p-2 sm:p-3 w-full
                                h-full rounded-md md:rounded-xl '>
                                    <input placeholder='Enter voucher code here' className='bg-transparent focus:outline-none text-[10px] md:text-sm' />
                                </div>
                                <button className='bg-primary w-[22vh] md:w-[26vh] rounded-md md:rounded-xl text-white p-2 text-[10px] md:text-sm'>
                                    Check Validity
                                </button>
                            </div>

                            <div className='mt-10'>
                                <h5 className='font-semibold text-sm sm:text-lg md:text-xl lg:text-2xl text-gray-900'>How to Redeem a Voucher</h5>

                                <div className='text-[#525252] text-[9px] md:text-xs lg:text-sm'>
                                    ...
                                    <div className='flex gap-3 mt-3'>
                                        ...
                                        Review benefits and Terms & Conditions carefully
                                    </div>
                                    <div className='flex gap-3 mt-3'>
                                        <CheckBadgeIcon className='h-5 w-5' />
                                        confirm and redeem voucher
                                    </div>
                                    <div className='flex gap-3 mt-3'>
                                        <HandThumbUpIcon className='h-5 w-5' />
                                        enjoy voucher benefits
                                    </div>
                                </div>
                            </div>
                        </div>
