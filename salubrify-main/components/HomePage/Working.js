                        ...
                        <div class="md:hidden flex flex-wrap w-full justify-center">
                            <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                                <div class="flex relative pb-12">
                                    ...
                                    <div class="flex-shrink-0 w-10 h-10 rounded-full bg-pink-200 inline-flex items-center justify-center text-gray-900 relative z-10">
                                    ...
                                    <div class="flex pl-4 items-center">
                                        <h2 class="text-sm text-gray-600 tracking-wider font-bold">Select a Service for Consultation</h2>
                                    </div>
                                </div>
                                ...
                                <div class="flex relative pb-12">
                                    ...
                                    <div class="flex pl-4 items-center">
                                        <h2 class="text-sm text-gray-600 tracking-wider font-bold">Speak to LIVE Pharmacist </h2>
                                    </div>
                                </div>
                                ...
                                <div class="flex relative">
                                    ...
                                    <div class="flex pl-4 items-center">
                                        <h2 class="text-sm text-gray-600 tracking-wider font-bold">Get Expert Advice </h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='container mt-4 mx-auto hidden md:flex justify-center'>
                            <div className='text-center'>
                                <div className='flex items-center mb-3'>
                                    <div class="flex-shrink-0 w-16 h-16 rounded-full bg-pink-200 inline-flex items-center justify-center text-white relative z-10">
                                ...
                                <span className='text-center mx-auto font-bold relative -left-20'>Select a Service <br /> for Consultation</span>
                            </div>
                            ...
                            <div>
                                ...
                                <p className='font-bold relative -left-3'>Speak to Live <br /> Pharmacist</p>
                            </div>

                            <div>
                                <div className='flex items-center text-center mb-3'>
                                    <div class="flex-shrink-0 w-16 h-16 rounded-full bg-pink-200 inline-flex items-center justify-center text-gray-900 relative z-10">
                                        <svg width="28" height="39" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6.83717 10.9333H8.57883V8.32078H11.1913V6.57911H8.57883V3.96661H6.83717V6.57911H4.22467V8.32078H6.83717V10.9333ZM2.483 14.4166C2.00404 14.4166 1.59417 14.2462 1.25338 13.9054C0.912016 13.5641 0.741333 13.1539 0.741333 12.6749V2.22494C0.741333 1.74598 0.912016 1.33611 1.25338 0.995326C1.59417 0.65396 2.00404 0.483276 2.483 0.483276H12.933C13.412 0.483276 13.8221 0.65396 14.1635 0.995326C14.5043 1.33611 14.6747 1.74598 14.6747 2.22494V6.14369L18.158 2.66036V12.2395L14.6747 8.75619V12.6749C14.6747 13.1539 14.5043 13.5641 14.1635 13.9054C13.8221 14.2462 13.412 14.4166 12.933 14.4166H2.483ZM2.483 12.6749H12.933V2.22494H2.483V12.6749Z" fill="#252525" />
                                        </svg>
                                    </div>
                                </div>
                                <p className='relative -left-4 font-bold'>Get a video call from <br /> our Specialist</p>
                            </div>
                        </div>
                    </div>
                </section>
