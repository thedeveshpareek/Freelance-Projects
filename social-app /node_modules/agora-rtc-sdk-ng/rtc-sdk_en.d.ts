 ...
 *
 * The event of join method timeout when connecting SD-RTN directly, fallback to using proxy.
 *
 * @param isUsingProxy The proxy server address which is used for fallback function of join.
 * @asMemberOf IAgoraRTCClient
 * @event
 */
...
export declare interface IAgoraRTC {
    ...
    ChannelMediaRelayError: typeof ChannelMediaRelayError;
    ChannelMediaRelayEvent: typeof ChannelMediaRelayEvent;
    ChannelMediaRelayState: typeof ChannelMediaRelayState;
    RemoteStreamFallbackType: typeof RemoteStreamFallbackType;
    RemoteStreamType: typeof RemoteStreamType;
    ConnectionDisconnectedReason: typeof ConnectionDisconnectedReason;
    AREAS: typeof AREAS;
    AudienceLatencyLevelType: typeof AudienceLatencyLevelType;
}
...
export declare interface LocalAudioTrackStats {
     ...
     * - `pcmu`: The audio codec is PCMU。
     * - `pcma`: The audio codec is PCMA。
     * - `g722`: The audio codec is g722。
...
export declare interface LocalVideoTrackStats {
     ...
     * - `"AV1X"`: The video codec is AV1 on Chrome before M96.
