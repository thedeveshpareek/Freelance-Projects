          ...
          <div className="filter-value filter-category">
            <label>
              <input
                type="checkbox"
                value="Laptops"
                checked={productState.category.includes("Laptops")}
                onChange={(e) =>
                  productDispatch({
                    type: CATEGORY,
                    payload: { value: e.target.value },
            ...
            <label>
              <input
                type="checkbox"
                value="Mobiles"
                checked={productState.category.includes("Mobiles")}
                onChange={(e) =>
                  productDispatch({
                    type: CATEGORY,
                    payload: { value: e.target.value },
            ...
            <label>
              <input
                ...
                checked={productState.category.includes("Laptops & Accessories")}
                onChange={(e) =>
                  productDispatch({
                    type: CATEGORY,
                    payload: { value: e.target.value },
